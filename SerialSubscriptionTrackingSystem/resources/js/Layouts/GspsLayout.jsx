...
export default function GspsLayout({ children, title, hideTitle = false }) {
  ...
  const isFullPage = hideTitle || isChatPage || pageTitle === 'Dashboard' || pageTitle === 'Supplier Info' || pageTitle === 'Delivery Status';
  ...
  return (
    <div style={{ display: 'flex', background: '#F5F6FA', minHeight: '100vh', height: '100vh', overflow: 'hidden' }}>
      <Head title={pageTitle === 'Chat' ? 'GSPS Chat' : pageTitle} />
      {/* Mobile Overlay */}
