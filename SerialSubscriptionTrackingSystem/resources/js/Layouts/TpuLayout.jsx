...
export default function TPULayout({ children, title = 'Dashboard' }) {
  ...
  const isFullPage = isChatPage || title === 'Add Account' || title === 'Supplier Information' || title === 'Subscription Tracking' || title === 'Monitor Delivery';
    ...
    <div style={{ display: 'flex', fontFamily: 'Segoe UI, Arial, sans-serif', background: '#f0f4f8', minHeight: '100vh' }}>
      ...
      <div style={{ flex: 1, marginLeft: 160 }}>
        ...
        <div style={{ 
          ...
          height: isFullPage ? 'calc(100vh - 73px)' : 'auto',
          overflow: isFullPage ? 'hidden' : 'visible'
        }}>
          {!isFullPage && (
            <>
