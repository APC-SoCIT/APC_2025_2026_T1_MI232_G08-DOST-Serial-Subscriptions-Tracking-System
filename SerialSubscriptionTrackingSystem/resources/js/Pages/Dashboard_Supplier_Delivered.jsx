...
const serials = [
  ...
  {
    no: 4,
    serial_title: "Journal of the American Medical Association",
    purchase_order_no: "PO-2024-1421",
    no_of_delivered_issues: 48,
    amount_equivalent: 12600.00,
    delivered_date: "2024-12-01",
  },
  {
    no: 5,
    serial_title: "New England Journal of Medicine",
    purchase_order_no: "PO-2024-1489",
    no_of_delivered_issues: 52,
    amount_equivalent: 15900.00,
    delivered_date: "2024-11-22",
  },
];
...
function Dashboard_Supplier_Delivered() {
  const [activeSidebar, setActiveSidebar] = useState(5);
  const [page, setPage] = useState(1);
  const totalPages = 10;

  // === NEW STATE ===
  const [searchQuery, setSearchQuery] = useState("");
  // Default to true (Newest first)
              ...
              >
                <thead>
                  <tr style={{ color: "#222", fontWeight: 700, borderBottom: '1px solid #eee' }}>
                    ...
                    <th style={{ padding: "12px 8px", textAlign: "center", width: 340 }}>No. of Delivered Issues</th>
                    <th style={{ padding: "12px 8px", textAlign: "center", width: 120 }}>Amount Equivalent</th>
                    <th style={{ padding: "12px 8px", textAlign: "center", width: 120 }}>Delivered Date</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredAndSortedSerials.length > 0 ? (
                    filteredAndSortedSerials.map((row, idx) => (
                      ...
                      >
                        ...
                        <td style={{ padding: "16px 8px", textAlign: "center", width: 340, fontWeight: "bold", color: "#28a745" }}>
                          {row.no_of_delivered_issues}
                        </td>
                        <td style={{ padding: "16px 8px", textAlign: "center", width: 120 }}>
                          {row.amount_equivalent.toLocaleString()}
                        </td>
                        <td style={{ padding: "16px 8px", textAlign: "center", width: 340, fontWeight: 500, color: "#555" }}>
                          {row.delivered_date}
                        </td>
                      </tr>
                    ))
...
export default Dashboard_Supplier_Delivered;