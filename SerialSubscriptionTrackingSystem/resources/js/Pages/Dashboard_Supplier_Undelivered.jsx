...
import { BiSortAlt2 } from "react-icons/bi"; // Added sort icon
...
function Dashboard_Supplier_Undelivered() {
  ...
  const filteredAndSortedSerials = useMemo(() => {
    ...
    // 1. Search Filter (Title or PO Number)
    if (searchQuery) {
    ...
    // 2. Sort Logic (By Number )
    result.sort((a, b) => {
      const countA = parseInt(a.no, 10) || 0;
      const countB = parseInt(b.no, 10) || 0;

      return isSortDescending ? countB - countA : countA - countB;
    });

    return result;
  }, [searchQuery, isSortDescending]);
              ...
              <div style={{ padding: "20px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <button 
                  ...
                  style={{
                    ...
                    background: isSortDescending ? '#004A98' : '#fff',
                    color: isSortDescending ? '#fff' : '#004A98',
                    cursor: 'pointer',
                    fontSize: 14,
                    fontWeight: 600,
                    transition: 'all 0.2s'
              ...
              >
                <thead>
                  <tr style={{ color: "#222", fontWeight: 700, borderBottom: '1px solid #eee' }}>
                    ...
                    <th style={{ padding: "12px 8px", textAlign: "center", width: 340 }}>Serial Title</th>
                    <th style={{ padding: "12px 8px", textAlign: "left", width: 120 }}>Purchase Order No.</th>
                    <th style={{ padding: "12px 8px", textAlign: "center", width: 120 }}>No. of Undelivered Issues</th>
                    <th style={{ padding: "12px 8px", textAlign: "center", width: 120 }}>Amount Equivalent</th>
                    <th style={{ padding: "12px 8px", textAlign: "center", width: 340 }}>Remarks</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredAndSortedSerials.length > 0 ? (
                    filteredAndSortedSerials.map((row, idx) => (
                      ...
                      >
                        ...
                        <td style={{ padding: "16px 8px", textAlign: "center", width: 340, fontWeight: 700, color: "#004A98" }}>
                          {row.serial_title}
                        </td>
                        <td style={{ padding: "16px 8px", textAlign: "left", width: 120 }}>{row.purchase_order_no}</td>
                        <td style={{ padding: "16px 8px", textAlign: "center", width: 120, fontWeight: "bold", color: "#d9534f" }}>
                          {row.no_of_undelivered_issues}
                        </td>
                        <td style={{ padding: "16px 8px", textAlign: "center", width: 120 }}>{row.amount_equivalent}</td>
                        <td style={{ padding: "16px 8px", textAlign: "center", width: 340, fontWeight: 500, color: "#555" }}>{row.remarks}</td>
                      </tr>
                    ))
                  ) : (
                    <tr>
...
export default Dashboard_Supplier_Undelivered;